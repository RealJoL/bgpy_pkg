...
as_graph_info_provider_attacker = ASGraphInfo(
    #peer_links=frozenset([PeerLink(peer1_asn=1, peer2_asn=ASNs.ATTACKER.value)]),
...
config_039 = EngineTestConfig(
    name="039",
    desc="Multi-peak ASPV-based scenario (Fig. 5 in ROV paper) with attacker as provider",
